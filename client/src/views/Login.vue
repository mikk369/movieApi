<template>
  ...
  <form id="form">
    ...
    <div class="emailInput">
      <input id="email" type="text" v-model="email" placeholder="Email" required @input="clearError"/>
    </div>

    <div class="passwordInput">
      <input id="password" type="password" v-model="password" placeholder="password" required @input="clearError"/>
    </div>
