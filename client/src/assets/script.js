...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Check if movies exist in local storage and it's an array
  if (window.location.pathname === '/') {
    ...
    reverseArr.forEach((localMovies) => {
      ...
      movieContainer.innerHTML = `
            <div class="card-box">
                  ...
                  <h4 class="movie-name"><b>${localMovies.Title}</b></h4>
                    ...
                    <div class="liked-button-wrapper">
                    <button class="like-button-heart" data-movie="${localMovies.imdbID}"><svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
      ...
      // Check if the movie is already in the apiLikedMovies
      const isAlreadyLiked = apiLikedMovies.includes(localMovies.imdbID);
      ...
      likeButton.addEventListener('click', () => {
        ...
        if (!isAlreadyLiked) {
          ...
          // Handle the Unlike action here (e.g., update the UI)
          console.log('Unliked:', localMovies.Title);
